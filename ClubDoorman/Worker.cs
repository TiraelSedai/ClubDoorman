...
<i>🤖 Этапы работы:</i>
1) Новый участник → проверка спам-списков, тихая блокировка известных спамеров
2) Капча (60 сек). Не решил — блок с очисткой сообщений
3) Первые 3 сообщения: только текст, без медиа/ссылок/эмодзи
4) Подозрение на спам → предупреждение + удаление
5) 3 хороших сообщения → полная свобода!
