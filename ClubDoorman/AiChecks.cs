            ...
            async ct =>
            {
                ...
                try
                {
                    ...
                    var prompt =
                        ...
                        "В SelfPromotionProbability ответь, с какой вероятностью профиль направлен на само-продвижение, ОСОБЕННО если у него род деятельности или намёк на бизнес указан прямо в имени (например коучинг, HR, 'Образование всех ступеней', или 'Алгоритм изобилия'), если у него предложение вступить в группу, подписываться, бесплатные продукты, и другие способы привлечения" +
                        $"\nВот данные профиля:\n{nameBioUser}";
